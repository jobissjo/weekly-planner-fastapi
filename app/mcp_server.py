...
mcp_user_var: contextvars.ContextVar[Optional[User]] = contextvars.ContextVar("mcp_user", default=None)
...
async def get_mcp_user() -> User:
    ...
    raise ValueError("Authentication required. Set AUTH_TOKEN or MCP_USER_EMAIL for stdio, or supply a token for SSE.")
...
async def list_my_tasks(
    ...
    """
    user = await get_mcp_user()
    return await mcp_tools.list_my_tasks_tool(user=user, from_date=from_date, end_date=end_date)
